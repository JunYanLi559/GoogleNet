...
class Classifier(object):
    ...
    def get_feat(self, TrainData, TestData):
        ...
        np.save("test_feat_rbf.npy", test_feat)
        ...
        np.save("train_feat_rbf.npy", train_feat)
    ...
    def run(self):
        if os.path.exists("train_feat_rbf.npy") and os.path.exists("test_feat_rbf.npy"):
            train_feat = np.load("train_feat_rbf.npy")
            test_feat = np.load("test_feat_rbf.npy")
        else:
